...
load("C:/Users/sofia/OneDrive/Documenti/DRD - R/DRD_2025_Lesson_2-20250605/Illumina450Manifest_clean.RData")
...
# Check if the BH-adjusted p-values are mostly non-significant or all equal to 1
summary(final_ttest_corr$corr_pval_BH)
#or
table(final_ttest_corr$corr_pval_BH < 0.01) 
