...
#Load the raw data and create the RGChannelSet object
rm(list=ls())
...
# Calcola le medie per ciascun probe (riga)
...
# Subset the manifest into Type I and Type II probes
dfI <- Illumina450Manifest_clean[Illumina450Manifest_clean$Infinium_Design_Type == "I", ]
dfII <- Illumina450Manifest_clean[Illumina450Manifest_clean$Infinium_Design_Type == "II", ]
dfI <- droplevels(dfI)
dfII <- droplevels(dfII)

# Subset the raw beta matrix by probe chemistry
...
# Calculate mean and sd of raw Beta
...
# Calculate density of mean and sd of raw Beta
...
# Calculate density of mean and sd of normalized Beta
...
# Plot all 6 plots in a 2x3 grid
par(mfrow=c(2,3))
...
# Raw Beta boxplot
boxplot(beta_raw, outline=FALSE, col=rep(c("#0067E6", "#E50068"), length.out=ncol(beta_raw)), main="Raw Beta Boxplot", ylab="Beta Values")
