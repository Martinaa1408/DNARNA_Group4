...
setwd("C:/Users/aurim/Documents/Università/4anno/DNA_RNA_dynamics/Final_Report-20250529")
...
baseDir <- ("C:/Users/aurim/Documents/Università/4anno/DNA_RNA_dynamics/Final_Report-20250529")
...
#     (WT and MUT) and check whether the distribution of methylation values is different 
...
#     methylated probes between group WT and group MUT using the function assigned to each group.
...
# Metodo velocizzato usando rowttests dal pacchetto genefilter
if (!requireNamespace("genefilter", quietly = TRUE)) {
  BiocManager::install("genefilter")
}
library(genefilter)
# Creare fattore per i gruppi
group_factor <- factor(targets$Group)
# Applicare t-test vettorizzato 
t_test_results <- rowttests(beta_norm, group_factor)
# Estrarre solo i p-values
